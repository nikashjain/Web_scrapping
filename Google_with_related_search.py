...
def search(driver, len_containers, num_images, folder_name):
    ...
    for i in range(1, len_containers + 1):
        if i == 25 or i == 50 or i == 75:
            continue
        if i == 100:
            xPath = f"""//*[@id="islrg"]/div[1]/div[51]/div[{50}]"""
        ...
        if i <= 49:
            ...
            previewImageXPath = (
                f"""//*[@id="islrg"]/div[1]/div[51]/div[{b}]/a[1]/div[1]/img"""
            )
        ...
        while True:
            ...
            if imageURL != previewImageURL:
                ...
                if currentTime - timeStarted > 4:
                    print(
                        "Timeout! Will download a lower resolution image and move on to the next one"
                    )
                    break
        ...
        try:
            ...
            print(
                f"Downloaded element {current_image_count} out of {num_images}. URL: {imageURL}"
            )
